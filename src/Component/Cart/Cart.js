      ...
      {cartItems.length === 0 ? (
        ...
        >
          <div className="text-center">
            ...
            <p className="text-[#ee4d2d] text-lg ">
        ...
        <>
          <h1 className="max-w-5xl px-8 xl:px-0 mx-auto text-left mb-10 text-2xl font-bold">
            Giỏ hàng
          </h1>
          <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
            ...
            <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
              <div className="mb-2 flex justify-between">
                ...
                <p className="text-gray-700">{VND.format(tongtien)}</p>
              </div>
              <div className="flex justify-between">
                <p className="text-gray-700">Phí vận chuyển</p>
                <p className="text-gray-700">{VND.format(30000)}</p>
              </div>
              <hr className="my-4" />
              <div className="flex justify-between">
              ...
              <button className="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600">
                <NavLink className="text-white no-underline" to={"/CheckOut"}>
                  Thủ tục thanh toán
                </NavLink>
              </button>
            </div>
